...
# SECRET_KEY = 'gj8hzzp$hsxw@)3q9_&e2puls7a3_0h%lh3=y*f=ht=8_wj0vr'
SECRET_KEY = os.environ.get("DJANGO_SECRET", "wLv2Ty]>29YG<9zNnu<n")
...
ALLOWED_HOSTS = [".elasticbeanstalk.com", "127.0.0.1", "127.0.0.1:8080"]
...
EMAIL_FROM = "noreply@sandbox135f585e41804cee92bb628014e860dc.mailgun.org"
...
if not DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = 'elasticbeanstalk-ap-northeast-2-329078347595'
