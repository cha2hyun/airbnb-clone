...
def github_login(request):
    ...
    redirect_uri = "http://airbnb-clone.gab38tdcvk.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback"
    return redirect(
        ...
        if code is not None:
            ...
            if error is not None:
                ...
                if username is not None:
                    ...
                    raise GithubException("Check your github profile")
...
def kakao_login(request):
    ...
    redirect_uri = "http://airbnb-clone.gab38tdcvk.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"
    return redirect(
...
class UpdateProfileView(mixins.LoggedInOnlyView, SuccessMessageMixin, UpdateView):
    ...
    # def form_valid(self, form):
    #     # Intercept when user click save.
    #     # check email and put in the username.
    #     email = form.cleaned_data.get("email")
